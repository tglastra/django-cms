...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.colour'
        db.add_column('cms_page', 'colour', self.gf('django.db.models.fields.CharField')(default=u'#ef0606', max_length=20), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Page.colour'
        db.delete_column('cms_page', 'colour')
    ...
    models = {
        ...
        'cms.page': {
            ...
            'colour': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
